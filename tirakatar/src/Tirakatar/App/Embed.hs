...
createObjectURL_ b = liftJSM $ do
  void $ eval ("tirakatar_createObjectURL = function(a) { return window.URL.createObjectURL(a); }" :: Text)
  liftJSM $ jsg1 ("tirakatar_createObjectURL" :: Text) (toJSVal b)
